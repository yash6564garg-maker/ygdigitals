...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-[#00f0ff]/30 font-sans">
      ...
      <a 
        href="https://wa.me/919588518385?text=Hi,%20I%20want%20to%20know%20more%20about%20your%20AI%20services%20for%20real%20estate." 
      ...
      {/* SECTION 2 — HERO */}
      <section className="relative min-h-[85svh] md:min-h-[100svh] flex flex-col justify-center pt-20 lg:pt-24 overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 w-full flex flex-col lg:flex-row items-center relative z-10">
          ...
          <div className="w-full lg:w-[50%] flex flex-col items-center lg:items-start text-center lg:text-left mb-12 lg:mb-0 fade-in pt-12 lg:pt-0">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-[4rem] xl:text-[4.5rem] font-bold tracking-tight mb-6 leading-[1.1]">
              <span className="text-white block whitespace-normal md:whitespace-nowrap">We Build the AI</span>
              <span className="text-white block">That</span>
              <span className="text-[#00f0ff] block whitespace-normal md:whitespace-nowrap">Builds Your Business.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 mb-10 w-full sm:w-auto">
              ...
              <AuroraButton href="https://wa.me/919588518385?text=Hi,%20I%20want%20to%20know%20more%20about%20your%20services." className="min-w-[240px] bg-[#111] hover:bg-[#1a1a1a] border-[#25D366]/30" glowClassName="from-[#25D366] via-[#128C7E] to-[#25D366]">
      ...
      <section id="contact" className="py-20 md:py-32 relative overflow-hidden bg-[#0a0a0a]">
        ...
        <div className="max-w-[800px] mx-auto px-4 md:px-8 text-center relative z-10 fade-in">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <AuroraButton href="https://wa.me/919588518385?text=Hi,%20I%20want%20to%20know%20more%20about%20your%20services." className="min-w-[240px]">Chat on WhatsApp</AuroraButton>
