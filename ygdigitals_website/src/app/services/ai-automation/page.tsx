...
export default function AIAutomationPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-[#00f0ff]/30 font-sans">
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 w-full flex flex-col lg:flex-row items-center gap-12 relative z-10">
          ...
          <div className="w-full lg:w-[55%] flex flex-col items-start text-left fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10 w-full sm:w-auto">
              <AuroraButton href="tel:+911171366819">Book a Free Strategy Call</AuroraButton>
      ...
      <section id="products" className="py-20 md:py-32 bg-[#0a0a0a] border-t border-white/5">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="text-center mb-20 fade-in">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 tracking-tight">Three automations that change everything.</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 fade-in delay-1">
            ...
            <div className="bg-[#111] border-t-2 border-t-[#00f0ff] border-x border-b border-white/5 rounded-[2rem] p-8 hover:bg-[#151515] transition-colors flex flex-col">
              ...
              <div className="mt-auto">
                ...
                <a href="tel:+911171366819" className="text-[#00f0ff] font-bold flex items-center gap-2 hover:gap-3 transition-all">Talk to Sales <ArrowRight size={16}/></a>
              </div>
            </div>
      ...
      <section id="whatsapp-agent" className="py-16 md:py-24 bg-[#0a0a0a] border-t border-white/5">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-[55%] fade-in delay-1">
              ...
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-10">Never miss a lead at 11pm again.</h2>
              ...
              <div className="bg-[#111] border border-white/5 border-l-4 border-l-[#00f0ff] p-6 md:p-8 rounded-2xl max-w-md">
                ...
                <AuroraButton href="tel:+911171366819" className="w-full text-center py-4">Set Up My WhatsApp Agent</AuroraButton>
              </div>
      ...
      <section id="calling-agent" className="py-16 md:py-24 bg-[#0a0a0a] border-t border-white/5">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="flex flex-col-reverse lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-[55%] fade-in">
              ...
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-6">Never miss a call. Ever.</h2>
              ...
              <div className="bg-[#111] border border-white/5 border-l-4 border-l-[#00f0ff] p-6 md:p-8 rounded-2xl max-w-md">
                ...
                <AuroraButton href="tel:+911171366819" className="w-full text-center py-4">Set Up My AI Calling Agent</AuroraButton>
              </div>
      ...
      <section id="custom-automation" className="py-20 md:py-32 bg-[#0a0a0a] border-t border-white/5">
        <div className="max-w-[1000px] mx-auto px-4 md:px-8 text-center fade-in">
          
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-6">Need something specific? We build it.</h2>
          ...
          <div className="bg-[#111] border border-[#00f0ff]/30 shadow-[0_0_40px_rgba(0,240,255,0.1)] rounded-[2rem] p-10 md:p-16 max-w-3xl mx-auto">
            ...
            <AuroraButton href="tel:+911171366819" className="py-4 px-8 text-lg">Book Free Automation Audit</AuroraButton>
          </div>
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16 fade-in delay-1 items-start">
            ...
            <div className="bg-[#111] border-t-2 border-t-[#00f0ff] border-x border-b border-white/5 rounded-3xl p-8 flex flex-col h-full">
              ...
              <AuroraButton href="tel:+911171366819" className="w-full text-center">Get Started</AuroraButton>
            </div>
            ...
            <div className="bg-[#111] border border-white/5 rounded-3xl p-8 flex flex-col h-full">
              ...
              <a href="tel:+911171366819" className="relative inline-flex items-center justify-center rounded-full bg-transparent px-6 py-3 text-white font-bold tracking-wide transition-all border border-white/20 hover:bg-white/5 hover:scale-105 w-full">
                Talk to Sales
              </a>
            </div>
          ...
          <div className="text-center fade-in delay-2 max-w-2xl mx-auto flex flex-col items-center">
            ...
            <AuroraButton href="tel:+911171366819">Book Free Audit</AuroraButton>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="py-32 relative overflow-hidden bg-[#0a0a0a]">
        ...
        <div className="max-w-[800px] mx-auto px-4 md:px-8 text-center relative z-10 fade-in">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-10">
            <AuroraButton href="https://wa.me/919588518385?text=Hi,%20I%20want%20to%20know%20more%20about%20your%20services." className="min-w-[240px]">
              <span className="flex items-center justify-center gap-2"><WhatsAppIcon size={18}/> Chat on WhatsApp</span>
            </AuroraButton>
            <a href="tel:+911171366819" className="relative inline-flex items-center justify-center rounded-full bg-transparent px-6 py-3 text-white font-bold tracking-wide transition-all border border-white/20 hover:bg-white/5 hover:scale-105 min-w-[240px]">
