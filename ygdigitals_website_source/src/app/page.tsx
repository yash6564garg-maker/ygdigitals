...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-[#00f0ff]/30 font-sans">
      ...
      {/* SECTION 2 — HERO */}
      <section className="relative min-h-[100svh] flex flex-col justify-center pt-24 overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 w-full flex flex-col lg:flex-row items-center relative z-10">
          ...
          <div className="w-full lg:w-[45%] flex flex-col items-start text-left mb-12 lg:mb-0 fade-in">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight mb-6 leading-[1.1]">
              <span className="text-white block">We Build the AI</span>
              <span className="text-white block">That</span>
              <span className="text-[#00f0ff] block">Builds Your Business.</span>
            </h1>
          ...
          <div className="w-full lg:w-[55%] h-[400px] lg:h-[700px] relative fade-in delay-1 flex justify-center lg:justify-end">
            <SplineScene 
      ...
      <section id="services" className="py-32 bg-[#0a0a0a]">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="text-center mb-16 fade-in">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight">Three systems. One unfair advantage.</h2>
          ...
          <div className="flex flex-col lg:flex-row gap-4 h-auto lg:h-[500px] min-h-[600px] w-full fade-in delay-1">
            ...
            >
              <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1485827404703-89b55fcc595e?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center opacity-20 mix-blend-luminosity"></div>
              <div className="absolute inset-0 bg-gradient-to-t from-black via-black/50 to-transparent"></div>
            ...
            >
              <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1616469829581-73993eb86b02?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center opacity-20 mix-blend-luminosity"></div>
              <div className="absolute inset-0 bg-gradient-to-t from-black via-black/50 to-transparent"></div>
      ...
      <section id="how-it-works" className="py-32 bg-[#0a0a0a]">
        <div className="max-w-[1000px] mx-auto px-4 md:px-8">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-20 text-center tracking-tight fade-in">How it works</h2>
          ...
          <div className="flex flex-col gap-16 md:gap-24 relative fade-in delay-1">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16 relative z-10 w-full">
              <div className="md:w-1/2 flex justify-end">
                <div className="text-[6rem] md:text-[8rem] font-black text-white/5 pointer-events-none select-none leading-none">01</div>
              </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-8 md:gap-16 relative z-10 w-full">
              <div className="md:w-1/2 flex justify-start">
                <div className="text-[6rem] md:text-[8rem] font-black text-white/5 pointer-events-none select-none leading-none">02</div>
              </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16 relative z-10 w-full">
              <div className="md:w-1/2 flex justify-end">
                <div className="text-[6rem] md:text-[8rem] font-black text-white/5 pointer-events-none select-none leading-none">03</div>
              </div>
              <div className="md:w-1/2 text-center md:text-left">
      ...
      <section id="pricing" className="py-32 bg-[#0a0a0a] border-t border-white/5">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="text-center mb-16 fade-in">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight">Transparent pricing. No surprises.</h2>
            <p className="text-lg text-[#888888] max-w-2xl mx-auto">
      ...
      <section id="contact" className="py-32 relative overflow-hidden bg-[#0a0a0a]">
        ...
        <div className="max-w-[800px] mx-auto px-4 md:px-8 text-center relative z-10 fade-in">
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 tracking-tight">Ready to put your business on autopilot?</h2>
