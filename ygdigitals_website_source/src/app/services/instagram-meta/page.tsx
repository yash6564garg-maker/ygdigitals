...
export default function InstagramMetaPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-[#00f0ff]/30 font-sans">
      ...
      <section className="py-32 md:py-48 bg-[#080808] relative overflow-hidden flex items-center justify-center min-h-[70vh]">
        <div className="max-w-[1000px] mx-auto px-4 md:px-8 text-center flex flex-col gap-8 md:gap-12">
          ...
          <div className="mt-12 md:mt-20 fade-in delay-4" style={{transitionDelay: '600ms'}}>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-[#00f0ff] italic drop-shadow-[0_0_20px_rgba(0,240,255,0.3)]">
              We fix all of this.
            </h2>
          </div>
        </div>
      ...
      <section id="pillars" className="py-32 bg-[#0a0a0a] border-t border-white/5">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="text-center mb-20 fade-in">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight">Everything your brand needs to dominate Instagram.</h2>
      ...
      <section className="py-24 bg-[#0d0d0d] border-t border-white/5 overflow-hidden">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-[52%] fade-in delay-1">
            ...
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">We create content that stops the scroll.</h2>
      ...
      <section className="py-24 bg-[#0a0a0a] border-t border-white/5 overflow-hidden">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 flex flex-col-reverse lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-[52%] fade-in">
            ...
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">Every rupee tracked. Every lead counted.</h2>
            <p className="text-lg text-[#888888] mb-10 leading-relaxed">
      ...
      <section className="py-32 bg-[#080808] border-t border-white/5">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="text-center mb-16 fade-in">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">AI videos that look human. Priced for real businesses.</h2>
            <p className="text-lg text-[#888888] max-w-2xl mx-auto">
      ...
      <section className="py-32 bg-[#0a0a0a] border-t border-white/5">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 text-center">
          <div className="mb-16 fade-in">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">Your own social media expert. Always on.</h2>
            <p className="text-lg text-[#888888] max-w-2xl mx-auto">
      ...
      <section className="py-32 bg-[#0a0a0a] border-t border-white/5">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="text-center mb-16 fade-in">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight">Transparent pricing. Built around your goals.</h2>
      ...
      <section id="contact" className="py-32 bg-[#0a1a14] border-t border-[#00f0ff]/10 relative overflow-hidden">
        ...
        <div className="max-w-[800px] mx-auto px-4 md:px-8 text-center relative z-10 fade-in">
          <h2 className="text-4xl md:text-6xl font-bold tracking-tight mb-6">Your brand deserves to be seen.</h2>
