  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-[#00f0ff]/30 font-sans">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 border-b ${isScrolled ? 'bg-black/80 backdrop-blur-xl border-white/10 py-4' : 'bg-transparent border-transparent py-6'}`}>
        <div className="container mx-auto px-4 md:px-8 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-8 items-center">
            ...
            <AuroraButton href="tel:+919817458931" className="py-2 px-5 text-sm">Let's Talk</AuroraButton>
          </div>
      ...
      <main className="pt-32 pb-24 overflow-hidden">
        ...
        <section className="container mx-auto px-4 md:px-8 relative mb-24 md:mb-40">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10 fade-in">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-8xl font-extrabold tracking-tight mb-6 md:mb-8 leading-[1.1]">
            ...
            <AuroraButton href="tel:+919817458931" className="w-full sm:w-auto text-lg">Book a Strategy Call</AuroraButton>
          </div>
        </section>

        {/* SECTION 2: WHAT MAKES OUR WEBSITES DIFFERENT */}
        <section className="container mx-auto px-4 md:px-8 mb-24 md:mb-40 fade-in">
        ...
        <section className="container mx-auto px-0 md:px-8 mb-24 md:mb-40 fade-in">
          ...
          <div className="flex overflow-x-auto pb-10 px-4 md:px-0 gap-6 md:gap-10 snap-x snap-mandatory hide-scrollbar">
            {['/images/IMG_8634.PNG', '/images/IMG_8635.PNG', '/images/IMG_8636.PNG', '/images/IMG_8637.PNG'].map((imagePath, index) => (
        ...
        <section className="container mx-auto px-4 md:px-8 fade-in">
          <div className="relative overflow-hidden bg-zinc-900 border border-white/10 rounded-[2rem] md:rounded-[3rem] p-8 md:p-24 text-center">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <AuroraButton href="tel:+919817458931" className="w-full sm:w-auto text-lg md:text-xl">Book a Strategy Call</AuroraButton>
            </div>
          </div>
        </section>
      </main>
