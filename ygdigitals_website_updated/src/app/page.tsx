      ...
      <section className="relative min-h-[100svh] flex flex-col justify-center pt-24 overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 w-full flex flex-col lg:flex-row items-center relative z-10">
          ...
          <div className="w-full lg:w-[50%] flex flex-col items-center lg:items-start text-center lg:text-left mb-12 lg:mb-0 fade-in pt-12 lg:pt-0">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-[4rem] xl:text-[4.5rem] font-bold tracking-tight mb-6 leading-[1.1]">
            ...
            <p className="text-lg text-[#888888] mb-10 max-w-lg mx-auto lg:mx-0 leading-relaxed">
